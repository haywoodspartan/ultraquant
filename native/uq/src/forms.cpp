...
bool informative(const std::string& token) {
    static const std::set<std::string> stop = {
        ...
        "give", "got", "had", "has", "have", "here", "how", "i", "if",
        "in", "into", "is", "it", "it's", "its", "just", "know",
        "let", "look", "make", "many", "may", "me", "might", "mine",
        "more", "most", "much", "must", "my", "need", "no", "not",
        "of", "on", "or", "other", "our", "ours", "same", "see",
        "should", "show", "so", "some", "take", "tell", "than",
        "that", "the", "their", "them", "then", "there", "these",
        "they", "think", "this", "those", "to", "us", "use", "used",
        "using", "very", "want", "was", "we", "were", "what", "when",
